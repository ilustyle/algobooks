...
========================================
    ...
    #. `색종이 이어 붙이기 <https://github.com/algocoding/lecture/blob/master/dp/src/Day4_1Paper.java>`_
    
    #. `행동 패턴 유사성 <https://github.com/algocoding/lecture/blob/master/dp/src/Day4_2LCS.java>`_
    
    #. `행렬곱 <https://github.com/algocoding/lecture/blob/master/dp/src/Day4_3Matrix.java>`_
